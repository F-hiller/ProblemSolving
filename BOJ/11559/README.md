[11559번: Puyo Puyo](https://www.acmicpc.net/problem/11559)

## 사고의 흐름

구현과 bfs를 합친 문제였다. 매턴 모든 문자들을 아래로 이동시키고 bfs를 통해 4개이상 연결된 블럭들을 터뜨려줬다. 터진 블럭이 있으면 cnt를 1 증가시켰고 터진 블럭이 없으면 cnt가 답이된다.
